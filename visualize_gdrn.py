...
def main(args):
    ...
    for scene_dir in scene_dirs:
        ...
        for rgb_name in rgb_names:
            ...
            axs[0, 0].imshow(plt.imread(rgb_path))
            axs[0, 0].plot(points[0, [0, 1]], points[1, [0, 1]], 'r')
            axs[0, 0].plot(points[0, [0, 2]], points[1, [0, 2]], 'g')
            axs[0, 0].plot(points[0, [0, 3]], points[1, [0, 3]], 'b')
            axs[0, 0].plot(points1[0, [0, 1]], points1[1, [0, 1]], 'r')
            axs[0, 0].plot(points1[0, [0, 2]], points1[1, [0, 2]], 'g')
            axs[0, 0].plot(points1[0, [0, 3]], points1[1, [0, 3]], 'b')
            ...
            if key in preds:
                for obj_id in preds[key]:
                    ...
                    axs[0, 0].plot(points2[0, [0, 1]], points2[1, [0, 1]], 'm')
                    axs[0, 0].plot(points2[0, [0, 2]], points2[1, [0, 2]], 'y')
                    axs[0, 0].plot(points2[0, [0, 3]], points2[1, [0, 3]], 'c')
            else:
                print(key)

            axs[0, 0].set_title(f'Frame {i_frame}')
