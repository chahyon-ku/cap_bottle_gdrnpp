...
OUTPUT_DIR = "output/gdrn/cap_bottle/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_hb"
INPUT = dict(
    DZI_PAD_SCALE=1.5,
    TRUNCATE_FG=False,
    CHANGE_BG_PROB=0.5,
...
DATASETS = dict(
    ...
    DET_FILES_TEST=("datasets/cap_bottle/test_100/test_bboxes/coco_instances_results_bop_test.json",),
